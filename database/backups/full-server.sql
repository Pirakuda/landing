...
--
-- Хост: localhost
-- Время создания: Авг 27 2025 г., 19:03
...
(1, 141, 'relanding.ru', 1756285623, 0, '2025-08-27 09:07:03');
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `source_type` enum('email','phone','social','websiteComments','websiteForm','websiteChat','telegramChat','websiteReviews','other') NOT NULL,
...
INSERT INTO `organization_sources` (`organization_id`, `source_type`, `source_value`, `role`, `config`, `is_confirmed`, `confirm_token`, `source_name`, `source_url`, `is_active`, `has_api`) VALUES
(141, 'website', 'relanding.ru', NULL, NULL, 1, NULL, 'Website relanding.ru', 'relanding.ru', 1, 1);
-- --------------------------------------------------------
